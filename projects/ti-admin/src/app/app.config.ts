import { APP_INITIALIZER, ApplicationConfig, inject, LOCALE_ID, provideAppInitializer, provideBrowserGlobalErrorListeners, provideZoneChangeDetection } from '@angular/core';
...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    {
      provide: LOCALE_ID,
      useValue: 'es-MX', // Establece el locale global de la app a español (México)
    },
